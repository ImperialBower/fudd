...
///
/// K♦ Q♦ J♠ J♣, 46.27% (792368), 53.34% (913354), 0.38% (6582)
/// K♦ Q♦ J♦ J♣, 45.96% (786991), 53.57% (917355), 0.46% (7958)
///
...
///
/// A♠ K♦ K♠ K♣, 29.74% (509318), 69.38% (1187967), 0.88% (15019) // Covered
/// A♥ K♣ K♠ K♥, 29.74% (509318), 69.38% (1187967), 0.88% (15019)
/// A♣ K♠ K♥ K♦, 29.60% (506801), 69.61% (1191993), 0.79% (13510) // Naked
